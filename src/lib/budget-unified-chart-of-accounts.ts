...
export const NYAH_EMPLOYER_SOCIAL_TAX_PAYABLE_ACCOUNT = '2 11 680';
export const NYAH_SANATORIUM_PAYABLE_ACCOUNT = '2 11 681';
export const NYAH_UNION_FEE_PAYABLE_ACCOUNT = '2 11 540';
export const NYAH_HHDT_PAYABLE_ACCOUNT = '2 11 590';
export const NYAH_OTHER_DEDUCTIONS_PAYABLE_ACCOUNT = '2 11 591';
export const NYAH_OTHER_TAX_PAYABLE_ACCOUNT = '2 11 690';
export const NYAH_SOCIAL_INSURANCE_EXPENSE_ACCOUNT = '5 11 100';
