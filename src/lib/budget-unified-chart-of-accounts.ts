...
import { NYAH_ACCOUNTS_FULL, NyahAccountRecord } from '@/data/nyah-accounts-full';
...
export type NyahAccountClassId = '1' | '2' | '3' | '4' | '5' | '6';
...
export const NYAH_CASH_ACCOUNT = '1 11 010';
export const NYAH_BANK_ACCOUNT = '1 12 010';
