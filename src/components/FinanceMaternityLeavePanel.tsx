    ...
    <section id="finance-maternity-leave" className="space-y-4 border-t border-[var(--border)] pt-6">
      ...
      <div className="space-y-4">
        ...
        <div
          ...
          lang="tg"
          translate="no"
          className="maternity-leave-document notranslate mx-auto max-w-3xl rounded-xl border border-slate-200 bg-white p-6 text-slate-900 shadow-sm print:border-0 print:shadow-none md:p-8"
        >
